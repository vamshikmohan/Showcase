function output = Parametric_Output_FUNCTION(T,n_points)
...
output = [camber, tmin,t,tmax, csmin,cs,csmax, kpmin,kp,kpmax, slmin,sl,slmax, laamin,laa,laamax, MotionRatioo];
